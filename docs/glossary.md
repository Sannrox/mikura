...
| **Schema descriptor** | Clerk-authored kind/property/link rules. Mikura validates writes against a supplied descriptor and may persist the last accepted one as `mikura.schema/<kind>`. Not a query language. [ADR 0008](decisions/0008-type-link-delete.md). |
