...
| **Sidecar** | A projection file next to the log (`{log}.joins`, magic `MKJOIN02`). Interned join keys and sum columns plus slim identity. Checksummed; deletable; rebuilt from the log. [ADR 0004](decisions/0004-slim-join-maps.md). |
