...
| **Schema descriptor** | Clerk-authored kind/property/link rules persisted as `mikura.schema/<kind>` (`properties`, `required`, `links`). Visible writes of that kind fail closed on unknown, missing required, or empty outgoing-link keys. `Store::load` still returns historical unvalidated rows; `Store::load_with_schema` applies a supplied check. Not a query language. [ADR 0008](decisions/0008-type-link-delete.md). |
