...
| **Action** | Governed edit in the product sense. `apply_action` appends a new visible generation and stores the clerk-assigned Action id ([ADR 0006](decisions/0006-action-provenance.md)). A repeated id with the same body is a replay ([ADR 0011](decisions/0011-action-id-retry-key.md)). |
