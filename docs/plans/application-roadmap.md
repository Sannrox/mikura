...
| Edits | Property overlay on the log; `apply_action` still whole-record replace; Action-id replay on `apply_action` ([ADR 0011](../decisions/0011-action-id-retry-key.md)); overlay Action-id replay accepted, not implemented ([ADR 0019](../decisions/0019-overlay-retry-and-mutation-boundaries.md), [#181](https://github.com/Sannrox/mikura/issues/181)); [merge](../../crates/mikura-ingest/src/merge.rs) replaces a whole record for one cycle | Source-sync offsets stay with the clerk ([#123](https://github.com/Sannrox/mikura/issues/123), [ADR 0020](../decisions/0020-resumable-source-reconciliation.md)). Multi-object atomic edits stay out ([#182](https://github.com/Sannrox/mikura/issues/182)). |
