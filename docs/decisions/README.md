...
| [0027](0027-overlay-apply-keeps-rematerialization.md) | A new overlay keeps rematerializing the instance; no patch-only path without a measured miss | accepted |
