...
| M10 capacity | One unpartitioned store. No partition key or ownership split. [#193](https://github.com/Sannrox/mikura/issues/193) is not implemented ([#192](https://github.com/Sannrox/mikura/issues/192), [ADR 0024](docs/decisions/0024-unpartitioned-store.md)). |
...
1. **M10:** availability closed retain-one-process ([#190](https://github.com/Sannrox/mikura/issues/190), [ADR 0023](docs/decisions/0023-single-process-availability.md)). Capacity closed unpartitioned ([#192](https://github.com/Sannrox/mikura/issues/192), [ADR 0024](docs/decisions/0024-unpartitioned-store.md)). 10¹⁰ stays blocked ([#55](https://github.com/Sannrox/mikura/issues/55)).
