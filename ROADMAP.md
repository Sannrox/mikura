...
1. **M7 features:** visibility enforcement ([#179](https://github.com/Sannrox/mikura/issues/179)) on load, evaluate (including existing count+sum), pages, links, and mutations. Extra aggregates stay out.
