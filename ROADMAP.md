...
1. **M10:** availability closed retain-one-process ([#190](https://github.com/Sannrox/mikura/issues/190), [ADR 0023](docs/decisions/0023-single-process-availability.md)). Failover writes closed no-action ([#191](https://github.com/Sannrox/mikura/issues/191)). Partitioning stays blocked until a named capacity miss ([#192](https://github.com/Sannrox/mikura/issues/192)). 10¹⁰ stays blocked ([#55](https://github.com/Sannrox/mikura/issues/55)).
