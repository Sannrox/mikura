...
2. **M3 — refresh-safe edits:** implement the overlay under
   [ADR 0009](docs/decisions/0009-refresh-safe-edit-overlay.md) so a source
   refresh keeps admitted properties.
